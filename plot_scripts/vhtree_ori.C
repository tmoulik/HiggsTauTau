...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TH1F *h1DiMuonEtaReco = new TH1F("h1DiMuonEtaReco","pT Ratio",100,-5,5);
   ...
   TH1F *hEtaPt10 = new TH1F("hEtaPt10","Reco Muon Eta 10",3,0,3);
   TH1F *hEtaPt15 = new TH1F("hEtaPt15","Reco Muon Eta 15",3,0,3);
   TH1F *hEtaPt20 = new TH1F("hEtaPt20","Reco Muon Eta 20",3,0,3);
   TH1F *hEtaPt25 = new TH1F("hEtaPt25","Reco Muon Eta 25",3,0,3);
   TH1F *hEtaPt30 = new TH1F("hEtaPt30","Reco Muon Eta 30",3,0,3);
   TH1F *hEtaPt35 = new TH1F("hEtaPt35","Reco Muon Eta 35",3,0,3);
   ...
   for (Long64_t jentry=0;jentry<nentries;jentry++) {
     ...
     dimuoneta=0.5*log((mag+Muon_pz[0]+Muon_pz[1])/(mag-Muon_pz[0]+Muon_pz[1]));
	 ...
	 hEtaPtBa->Fill(RecoMuonEta,RecoMuonPt);
       ...
       if (RecoMuonPt>10.)hEtaPt10->Fill(abs(RecoMuonEta));  
       if (RecoMuonPt>15.)hEtaPt15->Fill(abs(RecoMuonEta));  
       if (RecoMuonPt>20.)hEtaPt20->Fill(abs(RecoMuonEta));
       if (RecoMuonPt>25.)hEtaPt25->Fill(abs(RecoMuonEta));         
       if (RecoMuonPt>30.)hEtaPt30->Fill(abs(RecoMuonEta));
       if (RecoMuonPt>35.)hEtaPt35->Fill(abs(RecoMuonEta));  
       //if ()
     }
     //f1->cd();
     //tree->Write();
