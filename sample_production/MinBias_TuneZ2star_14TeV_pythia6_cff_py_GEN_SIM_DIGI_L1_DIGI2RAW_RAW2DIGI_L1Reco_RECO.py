...
# with command line options: GEMCode/GEMPhysics/python/MinBias_TuneZ2star_14TeV_pythia6_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,RAW2DIGI,L1Reco,RECO --conditions auto:upgrade2019 --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2019WithGem,Geometry/GEMGeometry/gemGeometryCustoms.custom_GE11_9and10partitions_v1 --beamspot Gauss --magField 38T_PostLS1 --datatier GEN-SIM-RECO --geometry Extended2019 --eventcontent RECOSIM -n 10 --no_exec --fileout MinBias_TuneZ2star_14TeV_pythia6_GEN_SIM_RECO_2019.root
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('GEMCode/GEMPhysics/python/MinBias_TuneZ2star_14TeV_pythia6_cff.py nevts:10'),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MinBias_TuneZ2star_14TeV_pythia6_GEN_SIM_RECO_2019.root'),
