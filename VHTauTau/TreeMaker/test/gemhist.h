...
// Mon Mar 31 22:38:17 2014 by ROOT version 5.34/07
...
const Int_t kMaxGenParticle = 1930;
const Int_t kMaxMuon = 2;
const Int_t kMaxTau = 48;
...
#ifdef gemhist_cxx
gemhist::gemhist(TTree *tree) : fChain(0) 
{
...
Int_t gemhist::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t gemhist::LoadTree(Long64_t entry)
{
...
void gemhist::Show(Long64_t entry)
{
...
Int_t gemhist::Cut(Long64_t entry)
{
